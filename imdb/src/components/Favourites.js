  ...
  return (
    <>
      <div className='flex justify-center flex-wrap space-x-2 mt-4 px-2'>
        {
          ...
          <button className={
            curGenre == genre ?
            'text-lg p-1 px-2 bg-blue-400 text-white rounded-xl font-bold m-2':
            'text-lg p-1 px-2 text-white rounded-xl font-bold m-2 bg-gray-400 hover:bg-blue-400'}
            onClick={()=>{
              setCurPage(1)
              setCurGenre(genre)}}
            >
      ...
      <div className='flex flex-col m-4'>
          <div className='my-2 overflow-x-auto sn:-mx-6 lg:-mx-8'>
